...
import { registerUser, userLogin, getContacts, createContact, updateContact, deleteContact } from './userAction'
  ...
  extraReducers(builder) {
    builder
        ...
        .addCase(getContacts.fulfilled, (state, { payload }) => {
            ...
            state.male = payload.contacts.filter((contact) => contact.gender === "male")
            state.female = payload.contacts.filter((contact) => contact.gender === "female")
            state.loading = false
            state.success = true
        })
