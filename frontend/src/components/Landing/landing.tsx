        ...
        <img src={phone} alt="phone" />
            ...
            <div className="boxes">
                <div className="item">
                    ...
                    <div className="icon"><img src={phonecreate} alt="phone" /></div>
                </div>
                <div className="item">
                  <div className="text two">Edit your contacts</div>
                    <div className="icon"><img src={phoneedit} alt="phone" /></div>
                </div>
                <div className="item">
                <div className="text three">Delete your contact</div>
                    <div className="icon"><img src={phonedelete} alt="phone" /></div>
                </div>
                <div className="item">
                <div className="text four">View all contact</div>
                    <div className="icon"><img src={phoneview} alt="phone" /></div>
                </div>
            </div>
